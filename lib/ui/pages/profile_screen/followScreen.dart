...
class _FollowScreenState extends State<FollowScreen> {
    ...
    void initState(){
      super.initState();
      print('aaaaaaa');
      _fetchFollower = context.read<SearchManager>().fetchFriend(context.read<AuthManager>().authToken!.user.Follower!,context.read<AuthManager>().authToken!.token!);
    }
    ...
    Widget build(BuildContext context) {
      ...
      return  Scaffold(
        ...
        appBar: AppBar(title: Text('Follower'),
